...
int main() {
	...
	cout << "Perimetrul cercului dat(folosind functia virtuala) este: " << C.perimetrul() << "\n";
	...
	cout << "Perimetrul dreptunghiului dat(folosind functia virtuala) este: " << DR.perimetrul() << "\n";
	P.setlatura(10);
	cout << "Perimetrul patratului dat este: " << P.perimetrupatrat() << "\n";
	cout << "Aria patratului dat este: " << P.ariepatrat() << "\n";
    cout << "Perimetrul patratului dat(folosind functia virtuala) este: " << P.perimetrul() << "\n";
}
